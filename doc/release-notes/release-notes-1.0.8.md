...
Daira Hopwood (15):
      ...
      Update which libraries are allowed to be linked to mlgbd by symbol-check.py.
      ...
      Line-wrap privacy notice. Use <> around URL and end sentence with '.'. Include privacy notice in help text for mlgbd -help.
...
Jay Graber (5):
      ...
      Add security warning to mlgb-cli --help and --version message output
      Add security warning to mlgbd metrics display
