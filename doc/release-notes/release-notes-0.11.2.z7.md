...
Taylor Hornby (17):
      ...
      Rename zerocash to mlgb in some places.
      Remove references to libzerocash in .gitignore
      Rename qa/zerocash to qa/mlgb in Makefile.am
      Rename zerocash_packages to mlgb_packages in packages.mk
