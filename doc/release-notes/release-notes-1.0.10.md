...
ECDSA signatures inside Mlgb transactions now use validation using
...
Daira Hopwood (8):
      ...
      Delete test that is redundant and inapplicable to Mlgb.
...
Jack Grigg (20):
      ...
      Hold an ECCVerifyHandle in mlgb-gtest
