...
Jack Grigg (14):
      ...
      Convert Mlgb versions to Debian format
      ...
      Implement automatic shutdown of deprecated Mlgb versions
...
Jay Graber (2):
      Change help text examples to use Mlgb addresses
...
Nathan Wilcox (39):
      ...
      Add all of the mlgb release tags in my current repo as positive test vector.
      ...
      Reuse mlgb_rpc.
      Do not use `-rpcwait` on all `mlgb_rpc` invocations, only block when starting mlgbd.
