...
Jack Grigg (21):
      ...
      Add Mlgb revision to version strings
      Bitcoin -> Mlgb in version and help text
      Add Mlgb Developers to CLI copyright notice
...
Nathan Wilcox (1):
      Fix a test name bug so that ``make cov-mlgb`` correctly runs the ``mlgb-gtest`` binary. Fixes #946.
...
Taylor Hornby (16):
      ...
      Turn on -Werror for the Mlgb build.
