#!/bin/bash
#
# Execute all of the automated tests related to Mlgb.
#
...
# Test phases:
run_test_phase "${REPOROOT}/qa/mlgb/check-security-hardening.sh"
run_test_phase "${REPOROOT}/qa/mlgb/ensure-no-dot-so-in-depends.py"
