...
function main() {
    ...
    cat <<EOF
Mlgb - fetch-params.sh

This script will fetch the Mlgb zkSNARK parameters and verify their
...
EOF
    ...
    then
        ...
        cat >> "$README_PATH" <<EOF
This directory stores common Mlgb zkSNARK parameters. Note that it is
