...
./mlgbd -printtoconsole -sendalert
...
void ThreadSendAlert()
{
    ...
    alert.nID           = 1003;  // use https://github.com/mlgb/mlgb/wiki/specification#assigned-numbers to keep track of alert IDs
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client is out of date and vulnerable to denial of service. Please update to the most recent version of Mlgb (1.0.8-1 or later). More info at: https://z.cash/support/security/";
    alert.strRPCError   = alert.strStatusBar;

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/MagicBean:0.7.2/"));
    const std::vector<std::string> useragents = {"MagicBean", "BeanStalk", "AppleSeed", "EleosMlgb"};
