...
bool CWalletDB::WriteCryptedZKey(const libmlgb::PaymentAddress & addr,
...
bool CWalletDB::WriteZKey(const libmlgb::PaymentAddress& addr, const libmlgb::SpendingKey& key, const CKeyMetadata &keyMeta)
{
    nWalletDBUpdated++;
