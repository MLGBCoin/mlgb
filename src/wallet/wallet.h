...
{
public:
    libmlgb::PaymentAddress address;
    ...
    CNoteData(libmlgb::PaymentAddress a) :
            address {a}, nullifier(), witnessHeight {-1} { }
    CNoteData(libmlgb::PaymentAddress a, uint256 n) :
...
{
    JSOutPoint jsop;
    libmlgb::NotePlaintext plaintext;
};
...
public:
    ...
    std::map<libmlgb::PaymentAddress, CKeyMetadata> mapZKeyMetadata;
    ...
    bool AddZKey(const libmlgb::SpendingKey &key);
    //! Adds spending key to the store, without saving it to disk (used by LoadWallet)
    bool LoadZKey(const libmlgb::SpendingKey &key);
    //! Load spending key metadata (used by LoadWallet)
    bool LoadZKeyMetadata(const libmlgb::PaymentAddress &addr, const CKeyMetadata &meta);
    //! Adds an encrypted spending key to the store, without saving it to disk (used by LoadWallet)
    bool LoadCryptedZKey(const libmlgb::PaymentAddress &addr, const libmlgb::ViewingKey &vk, const std::vector<unsigned char> &vchCryptedSecret);
    //! Adds an encrypted spending key to the store, and saves it to disk (virtual method, declared in crypter.h)
    bool AddCryptedSpendingKey(const libmlgb::PaymentAddress &address, const libmlgb::ViewingKey &vk, const std::vector<unsigned char> &vchCryptedSecret);
    ...
    boost::optional<uint256> GetNoteNullifier(
        ...
        const libmlgb::PaymentAddress& address,
