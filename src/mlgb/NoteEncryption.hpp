/*
See the Mlgb protocol specification for more information.
https://github.com/mlgb/zips/blob/master/protocol/protocol.pdf
*/
...
typedef libmlgb::NoteEncryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteEncryption;
typedef libmlgb::NoteDecryption<ZC_NOTEPLAINTEXT_SIZE> ZCNoteDecryption;
