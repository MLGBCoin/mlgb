...
} // end namespace `libmlgb`

typedef libmlgb::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH, libmlgb::SHA256Compress> ZCIncrementalMerkleTree;
typedef libmlgb::IncrementalMerkleTree<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libmlgb::SHA256Compress> ZCTestingIncrementalMerkleTree;

typedef libmlgb::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH, libmlgb::SHA256Compress> ZCIncrementalWitness;
typedef libmlgb::IncrementalWitness<INCREMENTAL_MERKLE_TREE_DEPTH_TESTING, libmlgb::SHA256Compress> ZCTestingIncrementalWitness;
