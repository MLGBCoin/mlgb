...
// To run tests:
// ./mlgb-gtest --gtest_filter="founders_reward_test.*"

//
// Enable this test to generate and print 48 testnet 2-of-3 multisig addresses.
// The output can be copied into chainparams.cpp.
// The temporary wallet file can be renamed as wallet.dat and used for testing with mlgbd.
//
#if 0
...
// On Mainnet, this would be 2,100,000 MGB after 850,000 blocks (840,000 + 10,000).
