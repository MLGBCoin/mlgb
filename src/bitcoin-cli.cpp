...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Mlgb RPC client version") + " " + FormatFullVersion() + "\n" + PrivacyInfo();
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  mlgb-cli [options] <command> [params]  " + _("Send command to Mlgb") + "\n" +
                  "  mlgb-cli [options] help                " + _("List commands") + "\n" +
                  "  mlgb-cli [options] help <command>      " + _("Get help for a command") + "\n";
