...
public:
    CMainParams() {
         ...
         * >>> 'Mlgb' + blake2s(b'The Economist 2016-10-29 Known unknown: Another crypto-currency is born. BTC#436254 0000000000000000044f321997f336d2908cf8c8d6893e88dbf067e2d949487d ETH#2521903 483039a6b6bd8bd05f0584f9a078d075e454925eb71c1f13eaff59b405a721bb DJIA close on 27 Oct 2016: 18,169.68').hexdigest()
         */
        const char* pszTimestamp = "Mlgb0b9c4eef8b7cc417ee5001e3500984b6fea35683a7cac141a043c42064835d34";
	...
	assert(consensus.hashGenesisBlock == uint256S("6bf25d624664ba4118f3c37ced99b0d8ef76a4d839a6ebdeb6c3b703771514dd"));
        //assert(genesis.hashMerkleRoot == uint256S("0xc4eaa58879081de3c24a7b117ed2b28300e7ec4c4c1dff1d3f1268b7857a4ddb"));
        assert(genesis.hashMerkleRoot == uint256S("af6de0555564ed6cd1a1ef4434a6646a1992aa6c64269aa313135af838905551"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("z.cash", "dnsseed.z.cash")); // Mlgb
...
public:
    CTestNetParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("f91419dbad5908018d3e3163af4f840602011646fa4d45d8e6ac6926ea845beb"));

        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("z.cash", "dnsseed.testnet.z.cash")); // Mlgb
...
public:
    CRegTestParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("b361ed12fd356f2c6d1fbf4b8254312f08b8a02344f526ac36978d3787447fa2"));
        nPruneAfterHeight = 1000;
