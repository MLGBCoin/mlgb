...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Mlgb mlgb-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mlgb-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mlgb transaction") + "\n" +
              "  mlgb-tx [options] -create [commands]   " + _("Create hex-encoded mlgb transaction") + "\n" +
              "\n";
