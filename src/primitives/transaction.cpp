...
JSDescription::JSDescription(ZCJoinSplit& params,
            ...
            const boost::array<libmlgb::JSInput, ZC_NUM_JS_INPUTS>& inputs,
            const boost::array<libmlgb::JSOutput, ZC_NUM_JS_OUTPUTS>& outputs,
            CAmount vpub_old,
            CAmount vpub_new,
            bool computeProof) : vpub_old(vpub_old), vpub_new(vpub_new), anchor(anchor)
{
    boost::array<libmlgb::Note, ZC_NUM_JS_OUTPUTS> notes;
